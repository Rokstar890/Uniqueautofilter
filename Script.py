...
class script(object):
    START_TXT = """<b>Hᴇʟʟᴏ {},ᴍʏ ɴᴀᴍᴇ <a href=https://t.me/{}>{}</a>,【I Cᴀɴ Pʀᴏᴠɪᴅᴇ Mᴏᴠɪᴇ Fᴏʀ Yᴏᴜ Jᴜsᴛ Aᴅᴅ Mᴇ Iɴ Yᴏᴜʀ Gʀᴏᴜᴘᢵᴄᴜꜱᴛᴏᴍɪᴢᴇᴅ ꜱʜᴏʀᴛɴᴇʀ ꜱᴜᴘᴘᴏʀᴛᢴ</b>"""

    HELP_TXT = """<b>Hᴇʏ {}
Hᴇʀᴇ Is Tʜᴇ Hᴇʟᴘ Fᴏʀ Mʏ Cᴏᴍᴍᴀɴᴅs.</b>"""

    ABOUT_TXT = f"""<b>⍟───[ MY ᴅᴇᴛᴀɪʟꜱ ]───⍟
‣ ᴍʏ ɴᴀᴍᴇ : <a href=https://t.me/Autofilternetflixbot>𝗠𝗼𝘃𝗶𝗲𝘀 𝗭𝗼𝗻𝗲 𝗕𝗼𝘁</a>
...
# Ask Doubt on telegram @KingVJ01
    ...
    EXTRAMOD_TXT = f"""ʜᴇʟᴘ: Exᴛʀᴀ Mᴏᴅᴜʟᴇs
<b>ɴᴏᴛᴇ:</b>
my features Stay here new features coming soon...  
 <b>✯ Maintained by : <a href=https://t.me/{BOT_USERNAME}>☢VJ☢</a></b>
  
 <b>✯ Join here : <a href=https://t.me/netflixvilla002>☢Join my updateds☢</a></b> 
 ...
 ./song - Download any song [<code>example /song Randi Babu Randi song</code>] 
...
〰️〰️〰️〰️〰️〰️〰️〰️
╭───🔅 ᴜᴘʟᴏᴀᴅ ʙʏ 🔅 ────╮
├• ▫️<a href=https://t.me/netflixvilla002>Netflix india</a>
╰───────────────────╯
〰️〰️〰️〰️〰️〰️〰️〰️〰️
...
ஏய் <a href='tg://settings'>My Friend</a> 
 ...
 படி 1: இந்த Movies Zone Filter Bot போட் உங்கள் குழுவை நிர்வாகியாக்குங்கள்
...
Hey <a href='tg://settings'>My Friend</a> 
 ...
 Step 1: Administer this Movies Zone Filter Bot bot to your group
...
హే <a href='tg://settings'>My Friend</a> 
 ...
 దశ 1: ఈ Movies Zone Filter Bot బాట్‌ని మీ సమూహానికి నిర్వహించండి
...
अरे <a href='tg://settings'>My Friend</a> 
 ...
 चरण 1: इस Movies Zone Filter Bot बॉट को अपने समूह में प्रशासित करें
...
ഹേയ് <a href='tg://settings'>My Friend</a> 
 ...
 ഘട്ടം 1: ഈ Movies Zone Filter Bot ബോട്ട് നിങ്ങളുടെ ഗ്രൂപ്പിലേക്ക് നൽകുക
...
നിങ്ങളുടെ ടീം വീഡിയോ ശേഖരണവും പരിശീലിപ്പിക്കും..."""
 ...
 مرحلہ 1: اپنے گروپ میں اس Movies Zone Filter Bot بوٹ کا انتظام کریں۔
...
અરે <a href='tg://settings'>My Friend</a> 
 ...
 પગલું 1: તમારા જૂથમાં આ Movies Zone Filter Bot બોટનું સંચાલન કરો
...
আরে <a href='tg://settings'>My Friend</a> 
 ...
 ধাপ 1: আপনার গ্রুপে এই Movies Zone Filter Bot বট পরিচালনা করুন
