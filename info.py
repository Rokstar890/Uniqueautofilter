...
BOT_USERNAME = environ.get('BOT_USERNAME', 'Netflixbest_bot')
# Others
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/cinemav00')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/cinemav00')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/cinemav00')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'Hello My Dear Friends ❤️')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', ''))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'cinemav00')
...
MULTI_CLIENT = False
name = str(environ.get('name', 'netflix_india_007'))
